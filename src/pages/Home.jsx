    ...
    <Container>
      ...
      {movieTitle === "" ? (
        <Row>
          <Col>
            <h2 className="py-4">
              ¿Queres Maratonear y no sabes que pelis ver?
            </h2>
            <p>
              Nosotros te ayudamos, pone una palabra y te saldran todas las
              peliculas que la contengan. No lo pienses mucho y empeza a
              disfrutar
            </p>
          </Col>
        </Row>
